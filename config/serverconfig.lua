...
ConfigCS.SpectateAllowed   = {"YakuzaYKZ-ACadmin"}
ConfigCS.ClearAreaAllowed  = {"YakuzaYKZ-ACadmin"}

-- Trigger Prohibidos - Añadir mas si es necesario.
ConfigCS.lynx = {
	"gcPhone:_2",
}
-- Palabras phohibidas - Añadir mas si es necesario.
ConfigCS.lol = {
	'Desudo',
	'Brutan',
	'EulenCheats',
...
-- Lista de explosiones - Añadir mas si es necesario.
